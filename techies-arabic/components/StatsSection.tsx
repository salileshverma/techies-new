...
const stats = [
  { num: '80', suffix: '+', label: 'مشروعاً تم تسليمه' },
  { num: '6',  suffix: '+', label: 'سنوات في سوق الخليج' },
  { num: '99', suffix: '%', label: 'معدل استبقاء العملاء' },
  { num: '99.8', suffix: '%', label: 'متوسط وقت تشغيل النظام' },
]
