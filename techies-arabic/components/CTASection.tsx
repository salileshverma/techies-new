  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[700px] mx-auto px-4 sm:px-7">
        <span className="inline-block text-[11px] font-bold uppercase tracking-[.15em] text-white/40 mb-5">جاهز للبناء؟</span>
        <h2 className="font-heading text-white text-[clamp(32px,5vw,52px)] font-extrabold tracking-[-2px] leading-[1.05] mb-5">
          لنبنِ شيئاً<br />قابلاً للتوسع.
        </h2>
        <p className="text-white/50 text-base leading-relaxed mb-10 max-w-lg mx-auto">
          أخبرنا عن مشروعك. سنرد خلال 24 ساعة بنطاق واضح وجدول زمني وتقييم فني صادق — بدون أساليب بيع.
        </p>
        ...
        <div className="mt-10 text-[13px] text-white/25 font-medium">
          مقرنا في الخليج · نخدم السعودية، الإمارات، قطر، الكويت، والبحرين · رد مضمون خلال 24 ساعة
        </div>
      </div>
    </section>
  )
